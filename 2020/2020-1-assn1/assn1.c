...
int get_swing_result(int is_final, int is_strike_full) {
	int result;
	int prob = rand() % 100	+ 1;
	if (0 < prob && prob <= 24)			result = 1;	// 안타
	else if (24 < prob && prob <= 35)	result = 2;	// 2루타
	else if (35 < prob && prob <= 43)	result = 3;	// 3루타
	else if (43 < prob && prob <= 48)	result = 4;	// 홈런
	else if (48 < prob && prob <= 70)	result = 5;	// 플라이 아웃 29~62
	else if (70 < prob && prob <= 100)	result = 6;	// 스트라이크 62~100
